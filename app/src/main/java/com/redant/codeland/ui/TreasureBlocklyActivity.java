...
public class TreasureBlocklyActivity extends AbstractBlocklyActivity implements View.OnClickListener{
    ...
    private static final String TAG = "TreasureBlocklyActivity";
    //当前所在的关卡，默认为0，即第一关
//    private int mIndex = 0;
    ...
    private String [] htmlPaths = {
            "file:///android_asset/treasure/html/level1.html",
            "file:///android_asset/treasure/html/level2.html",
            "file:///android_asset/treasure/html/level3.html",
            "file:///android_asset/treasure/html/level4.html",
            "file:///android_asset/treasure/html/level5.html",
            "file:///android_asset/treasure/html/level6.html",
            "file:///android_asset/treasure/html/level7.html",
            "file:///android_asset/treasure/html/level8.html",
            "file:///android_asset/treasure/html/level9.html",
            "file:///android_asset/treasure/html/level10.html"
    };
    //根据不同的关卡，加载不同的工具栏
    ...
    public Handler  handler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            int gameMaxLevel=sharedPreferences.getInt("gameTreasureMaxLevel",0);
            int gameUnlockLevel=sharedPreferences.getInt("gameTreasureUnlockLevel",0);
            //点击“完成”退出该活动
            if(msg.what == 1){
                //隐藏掉“礼花”效果
...
//                rating;
            ...
            else if(msg.what==3)
            {
                ...
                Util.showDialog2(TreasureBlocklyActivity.this, finalToastWord.toString(), rating,clickedLevel<gameMaxLevel-1, this);
            }else if(msg.what==5){
                ...
                //Toast.makeText(TreasureBlocklyActivity.this,"clicked："+clickedLevel+" unlock:"+gameUnlockLevel,Toast.LENGTH_SHORT).show();
                if((clickedLevel>=gameUnlockLevel-1)){
                    SharedPreferences.Editor editor=getSharedPreferences("AllLevel",MODE_PRIVATE).edit();
                    editor.putInt("gameTreasureUnlockLevel",clickedLevel+2);
                    editor.commit();
                }
                List<LevelInfo> rates= DataSupport.where("name = ?","treasure "+clickedLevel).find(LevelInfo.class);
                if(rates.isEmpty()){
                    LevelInfo rate=new LevelInfo();
                    rate.setName("treasure "+clickedLevel);
                    rate.setModel("treasure");
                    ...
                    if(rating>oldRating){
                        LevelInfo rate=new LevelInfo();
                        rate.setRating(rating);
                        rate.updateAll("name = ?","treasure "+clickedLevel);
                    }
                }
            }
    ...
    protected String getToolboxContentsXmlPath() {
        ...
        if(MyApplication.languageFlag==1){
            toolboxPaths.add("treasure/toolbox/toolbox_level1.xml");
            toolboxPaths.add("treasure/toolbox/toolbox_level2.xml");
            toolboxPaths.add("treasure/toolbox/toolbox_level3.xml");
            toolboxPaths.add("treasure/toolbox/toolbox_level3.xml");
            toolboxPaths.add("treasure/toolbox/toolbox_level3.xml");
            toolboxPaths.add("treasure/toolbox/toolbox_level3.xml");
            toolboxPaths.add("treasure/toolbox/toolbox_level3.xml");
            ...
            toolboxPaths.add("treasure/english_toolbox/english_toolbox_level1.xml");
            toolboxPaths.add("treasure/english_toolbox/english_toolbox_level2.xml");
            toolboxPaths.add("treasure/english_toolbox/english_toolbox_level3.xml");
            toolboxPaths.add("treasure/english_toolbox/english_toolbox_level3.xml");
            toolboxPaths.add("treasure/english_toolbox/english_toolbox_level3.xml");
            toolboxPaths.add("treasure/english_toolbox/english_toolbox_level3.xml");
            toolboxPaths.add("treasure/english_toolbox/english_toolbox_level3.xml");
    ...
    protected List<String> getBlockDefinitionsJsonPaths() {
        ...
        if(MyApplication.languageFlag==1){
        jsonPaths.add("treasure/tadpole.json");}
        else{
            jsonPaths.add("treasure/english_tadpole.json");
        }
        return jsonPaths;
    }
    ...
    protected List<String> getGeneratorsJsPaths() {
        ...
        jsPaths.add("treasure/generator.js");
        return jsPaths;
    }
        ...
        btnRun.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (getController().getWorkspace().hasBlocks()) {
                    ...
                    Toast.makeText(TreasureBlocklyActivity.this,getString(R.string.no_block_in_workspace),Toast.LENGTH_SHORT).show();
                    Log.i(TAG, "工作区中没有块");
                }
            }
        });
...
//                reload();
            ...
            case R.id.blockly_fbtn_help:
                TreasureBlocklyActivityNewNewbieGuide();
                drawerLayout.closeDrawers();
                break;
            case R.id.viewKonfetti:

//                Toast.makeText(TreasureBlocklyActivity.this,"你点击了 碎片礼花",Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(MyApplication.isFirstRun("TreasureBlocklyActivityNewbieGuide"))
        {
            TreasureBlocklyActivityNewNewbieGuide();
        }
    }
    ...
    //新手引导
    public void TreasureBlocklyActivityNewNewbieGuide(){
