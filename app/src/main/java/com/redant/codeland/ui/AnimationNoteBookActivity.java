...
public class AnimationNoteBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        button_back_enlighten_list.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MyApplication.playClickVoice(AnimationNoteBookActivity.this,"button");
                onBackPressed();
            }
        });
    }
    ...
    private void initData() {
        ...
        //从资源文件中加载所有的百科分类的名称
        String[] titles = getResources().getStringArray(R.array.animation_group_title);
        for (String t : titles) {
...
//        List<Baike> celebrityList = loadMaterialFromFile("celebrity/celebrity_title_url.txt");
        List<Baike> mazeList = loadMaterialFromFile("maze/maze_animation_title.txt");
