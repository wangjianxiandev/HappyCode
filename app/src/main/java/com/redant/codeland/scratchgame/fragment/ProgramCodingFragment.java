...
public class ProgramCodingFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId())
        {
            case 0:
                ...
                editor.commit();
                changeParentFragment(new BaseLevelFragment(),"printf");
                break;
            case 1:
                MyApplication.playClickVoice(getActivity(),"button");
                editor.putInt("clickedChapter",2);
                editor.commit();
                changeParentFragment(new BaseLevelFragment(),"math");
                break;
            case 2:
                MyApplication.playClickVoice(getActivity(),"button");
                editor.putInt("clickedChapter",3);
                editor.commit();
                changeParentFragment(new BaseLevelFragment(),"variable");
                break;
            case 3:
                MyApplication.playClickVoice(getActivity(),"button");
                editor.putInt("clickedChapter",4);
                editor.commit();
                changeParentFragment(new BaseLevelFragment(),"logic");
                break;
            case 4:
                MyApplication.playClickVoice(getActivity(),"button");
                editor.putInt("clickedChapter",5);
                editor.commit();
                changeParentFragment(new BaseLevelFragment(),"loop");
                break;
            case 5:
                MyApplication.playClickVoice(getActivity(),"button");
                editor.putInt("clickedChapter",6);
                editor.commit();
                changeParentFragment(new BaseLevelFragment(),"array");
                break;
        }
