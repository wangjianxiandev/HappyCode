...
public class ProgramCodeFragment extends Fragment implements View.OnClickListener {
    ...
    public void onStart() {
        super.onStart();
        String[] moduleName={getString(R.string.code_javascript),getString(R.string.code_python),getString(R.string.code_php),getString(R.string.code_lua),getString(R.string.code_dart),getString(R.string.code_xml)};
    ...
    public void onClick(View view) {
        ...
        switch (view.getId())
        {
            case 0:
                ...
                editor.commit();
                changeParentFragment(new BaseLevelFragment(),"javascript");
                break;
            case 1:
                MyApplication.playClickVoice(getActivity(),"button");
                editor.putInt("clickedChapter",2);
                editor.commit();
                changeParentFragment(new BaseLevelFragment(),"python");
                break;
            case 2:
                MyApplication.playClickVoice(getActivity(),"button");
                editor.putInt("clickedChapter",3);
                editor.commit();
                changeParentFragment(new BaseLevelFragment(),"php");
                break;
            case 3:
                MyApplication.playClickVoice(getActivity(),"button");
                editor.putInt("clickedChapter",4);
                editor.commit();
                changeParentFragment(new BaseLevelFragment(),"lua");
                break;
            case 4:
                MyApplication.playClickVoice(getActivity(),"button");
                editor.putInt("clickedChapter",5);
                editor.commit();
                changeParentFragment(new BaseLevelFragment(),"dart");
                break;
            case 5:
                MyApplication.playClickVoice(getActivity(),"button");
