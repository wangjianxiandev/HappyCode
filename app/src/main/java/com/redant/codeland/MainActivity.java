...
import com.redant.codeland.scratchgame.scratchanimation.ScratchAnimationBaseActivity;
import com.redant.codeland.scratchgame.scratchgameui.ProgramActivity;
import com.redant.codeland.scratchgame.scratchgameui.ScratchGameBaseActivity;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private MyButton  ivGame, ivCoding,buttonSet,buttonMusic,buttonHelp;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(MyApplication.languageFlag==1){
            ivEnghten.setText("动画编程");
            ivGame.setText("游戏编程");
            ivCoding.setText("程序编程");
